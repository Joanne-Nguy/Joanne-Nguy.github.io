...
A recipe for a beginner-friendly ginger bug soda flavored with ginger and honey.

#### Materials

- Food processor or knife
- 3 Wide-mouth jars (2 32oz and 1 8oz)
- Spoons
- Cheesecloth
...
||Ingredient|Amount|Preparation|
|:---|:---|:---|:---|
|<input type="checkbox">|Finely-chopped ginger|3 Tbsp|**Required**: Organic|
|<input type="checkbox">|Water|300mL, and more as needed|Room temperature; filtered or bottled|
|<input type="checkbox">|Honey|3 Tbsp|**Preferred**: Organic|
...
6. Strain the contents of the fermented soda into the bottle.
...
The [ginger bug](https://en.wikipedia.org/wiki/Ginger_beer) is a collection of wild yeasts and bacteria which are naturally occurring on the skins of most root vegetables, and in this case, we are using ginger. The bacteria are usually lactic acid bacteria (LABs), which digest sugars and produce lactic acid, causing the soda to develop an acidic tang over time. The yeasts will digest the sugars fed to it and LAB by-products, in return, producing alcohol and carbon dioxide. The alcohol content will be negligible if fermenting for less than a week; I've had a batch that was left to ferment for a little over a week and the flavor was dry but not alcoholic yet. The superstar by-product is carbon dioxide, which will help naturally carbonate our soda into a fizzy drink with delicate bubbles.
