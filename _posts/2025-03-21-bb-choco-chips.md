...
Additionally, [King Arthur's chocolate chip recipe](https://www.kingarthurbaking.com/blog/2023/12/27/recipe-of-the-year-chocolate-chip-cookies) uses a Tangzhong -- a milk bread roux made from cooked milk and flour -- to create an exceptionally chewy cookie. The roux is a combination of (whole) milk and flour cooked on the stove to create a pre-hydrated dough that lends itself to the chewiest texture I've ever experienced in a cookie. It's an extra step, but definitely worth it if you have the time to spare!
