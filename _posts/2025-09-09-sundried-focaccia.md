...
categories: recipes
thumbnail: "https://images.unsplash.com/photo-1619452357216-e88ca8119eeb?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
toc: 
  sidebar: left
---
...
|:---|:---|:---|:---|
|<input type="checkbox">|Sourdough starter|30g|From refrigerator or fresh|
|<input type="checkbox">|Water|60g|Filtered or bottled|
|<input type="checkbox">|All-purpose Flour|60g|None|
...
|<input type="checkbox">|Olive oil|2 Tbsp|None|
|<input type="checkbox">|Sun-dried tomatoes in olive oil|4 Tsp|None|
...
4. Place a rubber band at the level of the sourdough starter. Let sourdough starter rest until doubled in height from the rubber band.
- Starter doubling time will be dependent on ambient temperature, temperature of ingredients added and starter activeness. 
- Feeding the sourdough starter at a 1:2:2 ratio will take approximately 8-12h for starter from the fridge to double in size.
...
- This layer of olive oil will prevent the dough from drying out during the cold fermentation step.
7. Cover the mixing bowl with a cheesecloth or plastic wrap.
...
4. Place in a warm area and allow to bulk ferment for 4-6h.
...
<table>
  ...
  <tr>
    <th>Storage</th>
    <td>Keep at room temperature for up to 5 days or store in the refrigerator for up to 2 weeks.</td>
  </tr>
  <tr>
    <th>Reheating</th>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        ...
        loading="lazy" 
        path="https://images.unsplash.com/photo-1619452357216-e88ca8119eeb?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
        width="50%" 
